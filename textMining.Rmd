...
#3. Creación de TDM y inspección del mismo
```{r}
...
wordcloud(names(freq), freq, min.freq=10, max.words = 50, scale=c(4, .1), colors = dark2)
...
## 5. Buscar correlación entre palabras
```{r}
